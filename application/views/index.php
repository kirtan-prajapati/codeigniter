	        ...
	        <div class="col-md-4 mt-2">
	            <div class="card">
	                ...
	                <div class="card-body bg-light text-center">
	                    <div class="mb-2">
	                        <h6 class="font-weight-semibold mb-2"> <a href="#" class="text-default mb-2" data-abc="true"><?php echo $product['name']; ?></a> </h6> <a href="#" class="text-muted" data-abc="true">Laptops & Notebooks</a>
	                    </div>
